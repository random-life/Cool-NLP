# 词库介绍
1.该份数据包含了68个领域的领域词汇，共68个txt文件，每个文件以领域的名称命名。规模达到了**916万词**。
2.每个文件中的每一行包括两列(以tab符分开)，分别代表词语名称以及对应的权重。文件中的词语按照权重从大到小的方式排列，权重越高，该词对于领域的代表性或区分能力就越强。

# 数据来源
Github：[liuhuanyong/DomainWordsDict](https://github.com/liuhuanyong/DomainWordsDict)
